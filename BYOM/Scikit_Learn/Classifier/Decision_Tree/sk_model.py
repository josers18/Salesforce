# **************************************************************************************************
# PROJECT: BYOM Decision Tree Classifier for Retail Attrition Sample using Scikit Learn
# AUTHOR: Jose Sifontes
# ORIGIN: 2022-11-08
# PURPOSE: Create Classification Model for BYOM Decision Tree
# STEPS:
# 1) Import necessary libraries
# 2) Read the training data, process the variables and prepare the training data
# 3) Define and Create the Decision Tree model, verify accuracy scores
