# **************************************************************************************************
# PROJECT: BYOM Data Preprocessor for Isolation Forest Anomaly Classification Sample using Scikit Learn
...
# 3) Define postprocessor() to tidy up data and transform 1 | -1 outputs to binary class after running through model and append predictions to a list 
# **************************************************************************************************
